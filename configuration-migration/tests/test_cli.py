...
def _mock_args(**kwargs):
    """Build a MockArgs namespace with sensible defaults."""
    defaults = {
        'command': None,
        'config_file': None,
        'source_token': None,
...
class TestCLI:
    ...
    def test_main_no_command(self, mock_parse_args, mock_config_from_args, mock_exit):
        """Test main function when no command is provided."""
        mock_parse_args.return_value = _mock_args(command=None)
