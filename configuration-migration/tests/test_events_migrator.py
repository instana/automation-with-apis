...
class TestEventsMigrator:
    ...
    def test_prompt_for_duplicate_event_skip(self, mock_input, _):
    ...
    def test_prompt_for_duplicate_event_update(self, mock_input, _):
    ...
    def test_prompt_for_duplicate_event_cancel(self, mock_input, _):
    ...
    def test_prompt_for_duplicate_event_invalid_then_valid(self, mock_input, _):
