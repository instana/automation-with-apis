...
_configs_dir = os.path.join(os.path.dirname(__file__), '..', 'alert-configs')
_spec = importlib.util.spec_from_file_location("migrator", os.path.join(_configs_dir, "migrator.py"))
migrator = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(migrator)
sys.modules['migrator'] = migrator
AlertConfigsMigrator = migrator.AlertConfigsMigrator
